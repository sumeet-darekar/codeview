    ...
    <SyntaxHighlighter language="php" style={nord } >
       ...
       <h1 className=" text-yellow-50 py-4"> [ hint: ' ]</h1>
        ...
        <div className="popdown-content code rounded my-5">
          <pre className="font px-1 py-1 code-container">This php code is Vulnerable to sql injection <br />
...
<div className=" inline-flex">
      <Link href="/" className=" bg-red-600 rounded px-1 py-1 font">🏠 Home 🏠</Link>
      <br />
      <Link href="lvl2" className=" bg-red-600 rounded px-1 py-1 font mx-3.5">Next →</Link>
      <br />
      </div>
            </div>
